...
[![x-cmd/install — kure Code Quality Monitoring Repo Card](https://repo.x-cmd.io/kure.svg)](https://x-cmd.com/install/kure)
...
Total: **14,616** lines of code across **144** files in the top 5 languages.

| Language | Code | Comments | Blanks | Files |
|----------|-----:|---------:|-------:|------:|
| Go | 14,385 | 619 | 2,909 | 127 |
| Pan | 54 | 6 | 8 | 2 |
| Protobuf | 46 | 4 | 13 | 4 |
| Yaml | 44 | 15 | 11 | 5 |
| Json | 40 | 0 | 0 | 6 |
...
- **Upstream**: <https://github.com/GGP1/kure>
- **License**: Apache-2.0

## Release

- **Latest**: `v1.3.0` (2025-11-02)
- **Last commit**: 2026-09-01
- **Assets in release**: 28

## Popularity

- **Stars**: 171 · **Forks**: 15 · **Open issues**: 10 · **Contributors**: 3

## Totals (cumulative)

- **Releases**: 29 · **Merged PRs**: 76 · **Open PRs**: 0 · **Closed issues**: 10 · **Open issues**: 0 · **Commits**: 405

## Recent activity

| Window | Since | Releases | Merged PRs | Open PRs | Closed issues | Open issues | Commits |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-21 | 0 | 2 | 0 | 0 | 0 | 1 |
| last60d | 2026-07-22 | 0 | 6 | 0 | 0 | 0 | 5 |
| 90d | 2026-06-22 | 0 | 9 | 0 | 0 | 0 | 9 |
| last180d | 2026-03-24 | 0 | 22 | 0 | 2 | 0 | 21 |
| 360d | 2025-09-25 | 1 | 42 | 0 | 2 | 0 | 45 |
| last720d | 2024-09-30 | 4 | 50 | 0 | 2 | 0 | 127 |
...
Install metadata for kure lives in the [x-cmd/install](https://github.com/x-cmd/install) index — a curated YAML package list that x-cmd consumes at install time. If `kure` is missing, out of date, or installs incorrectly, please open an issue or PR there:

- **Open an issue**: <https://github.com/x-cmd/install/issues/new>
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/kure.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260920.yml` · 2026-09-20T04:55:23Z._
